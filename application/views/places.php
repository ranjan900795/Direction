                ...
                <div class="col-10 m-auto border">
                    <form method="POST" action="../admin/places_upload" class="px-3 py-3">
                        ...
                        <div class="form-group m-0 mb-2">
                            ...
                            <input type="name" name="destination" class="col-12 form-control form-control-sm" placeholder="Enter the destination name ">
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select id="inputState" class="form-control" name="database">
